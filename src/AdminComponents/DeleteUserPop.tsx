...
const DeleteUserPop = ({setShowPop, user} : {setShowPop : (b : boolean) => void, user : User}) =>{
    ...
    return(
            ...
            <div onClick={(e) => e.stopPropagation()}  className="flex flex-col justify-center items-center fixed top-30 bg-white w-[600px] rounded-xl max-[650px]:w-[300px]">
                <p className="mt-7 w-[400px] text-center font-bold max-[600px]:w-[200px]">Are you sure you want to delete user : {user.name}</p>
